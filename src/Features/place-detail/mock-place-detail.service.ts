...
export const mockPlaceDb: { place: PlaceDetailDto & { reviews: ReviewDto[] } } = {
    place: {
        ...
        images: [
            { id: 1, url: 'images/restaurant.jpg' },
            { id: 2, url: 'images/location.jpg' },
            { id: 3, url: 'images/business.jpg' },
            { id: 4, url: 'images/coffee.jpg' },
            { id: 5, url: 'images/restaurant.jpg' },
        ],
        avgRating: 0,
        reviewCount: 0,
    ...
    mockPlaceDb.place.reviews = [
        {
            ...
            dislikes: 1,
            images: [
                { id: 11, url: 'images/restaurant.jpg' },
                { id: 12, url: 'images/coffee.jpg' },
            ],
        },
        {
            id: ++seqId,
